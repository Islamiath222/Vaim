...
import { FaHeart, FaFacebookF, FaInstagram, FaXTwitter, FaYoutube, FaLocationDot, FaPhone, FaEnvelope } from 'react-icons/fa6'
          ...
          <div className="flex gap-3 mt-5">
            {[FaFacebookF, FaInstagram, FaXTwitter, FaYoutube].map((Icon, i) => (
              <a
                ...
                className="w-9 h-9 rounded-full bg-white/10 hover:bg-gold hover:text-purple-900 flex items-center justify-center transition-colors"
              >
                <Icon size={15} />
              </a>
            ))}
